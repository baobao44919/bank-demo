...
class Trade_model extends CI_Model
{
    ...
    public function update($table,$data,$where){
        return $this->def->where($where)->update($table,$data);
    }
    ...
    public function transfer($table,$user_id){
        return $this->def->select('sum(amount) as amount ')->get_where($table,['user_id' => $user_id,'type' => 3])->row_array();
    }
